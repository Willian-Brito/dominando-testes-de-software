...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Usuario", "Usuário - Cadastro", "  Como um visitante da loja\n  Eu desejo me cadastrar como usuário\n  Para que eu p" +
                    "ossa realizar compras na loja", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 7
    testRunner.Given("Que o visitante está acessando o site da loja", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 8
    testRunner.When("Ele clicar em registrar", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 9
    testRunner.And("Preencher os dados do formulario", ((string)(null)), table1, "And ");
#line hidden
#line 14
    testRunner.And("Clicar no botão registrar", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 15
    testRunner.Then("Ele será redirecionado para a vitrine", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 16
    testRunner.And("Uma saudação com seu e-mail será exibida no menu superior", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
...
#line hidden
                ...
                table2.AddRow(new string[] {
                            "Confirmação de senha"});
#line 21
    testRunner.And("Preencher os dados do formulario com uma senha sem maiusculas", ((string)(null)), table2, "And ");
#line hidden
#line 26
    testRunner.And("Clicar no botão registrar", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 27
    testRunner.Then("Ele receberá uma mensagem de erro que a senha precisa conter uma letra maiuscula", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3.AddRow(new string[] {
                            "Confirmação de senha"});
#line 32
    testRunner.And("Preencher os dados do formulario com uma senha sem caractere especial", ((string)(null)), table3, "And ");
#line hidden
#line 37
    testRunner.And("Clicar no botão registrar", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
